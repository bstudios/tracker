/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e2a8b30e0215cc45b2b74a4aa5de2a39)
// Runtime types generated with workerd@1.20260701.1 2026-06-23 nodejs_compat
interface __BaseEnv_Env {
	LOGBOOK_ARCHIVE: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	TRACKER_PASSWORD_LOGIN_RATE_LIMITER: RateLimit;
	BROWSER: BrowserRun;
	...
	DAILY_LOGBOOK_EMAIL: Workflow<Parameters<import("./workers/app").DailyLogbookEmailWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCESS_POLICY_AUD" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "PUBLIC_BASE_URL" | "LOGBOOK_EMAIL_FROM" | "LOGBOOK_PDF_SIGNING_SECRET">> {}
}
