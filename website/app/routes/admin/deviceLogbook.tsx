        ...
        <Form method="post">
          <Stack gap="md">
            ...
            <Textarea
              ...
              description="Leave blank to use the defaults: stop after 15 minutes within 100 m, signal lost after 20 minutes without a report, distance steps under 20 m ignored as GPS noise, and no voltage lines."
              name="logbookConfig"
